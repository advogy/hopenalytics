...
--}}
<div class="relative w-full sm:w-auto" data-searchable-select data-{{ $prefix }}-entity>
    ...
    <input
        ...
        class="w-full sm:w-56 rounded-full border border-black/10 bg-slate-50 py-2.5 pr-9 pl-9 text-sm font-medium shadow-sm transition hover:bg-slate-100 dark:border-white/10 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
    >
