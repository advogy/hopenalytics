...
@section('content')
    ...
    >
        ...
        <div class="mb-5 grid grid-cols-2 gap-4">
            ...
            <div>
                <label for="category" class="mb-1.5 block text-sm font-medium">{{ __('entity.category') }}</label>
                <select id="category" name="category" required class="w-full rounded-lg border border-black/10 bg-white px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:outline-none dark:border-white/10 dark:bg-slate-800">
