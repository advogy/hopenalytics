{{--
    ...
    by div-list layouts like components/growth-score-card.blade.php.
--}}
@props(['label', 'count', 'toggleId', 'ancestors' => null])

<div
    class="flex cursor-pointer items-center gap-2 rounded-lg bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-700 dark:bg-slate-800/60 dark:text-slate-200"
