...
return [
    ...
    'how_step_6' => 'Coordinates are looked up automatically in the background right after upload — no extra step needed. It runs gradually (about 1 location per second), so a large batch can take a few minutes before every marker shows up on the map.',
    'result' => 'Import complete — Data: :created created, :updated updated, :skippedInvalid skipped (blank Name), :skippedDaerahNotFound skipped (Conference not found), :skippedNotFound skipped (ID not found), :queued now being looked up in the background. Social: :socialCreated created, :socialUpdated updated, :socialSkipped skipped.',
];
