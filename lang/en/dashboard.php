...
return [
    ...
    'map_tab_heatmap' => 'Growth by Location',
    'map_summary_heatmap' => ':count location(s) have weekly growth data (green = growing, red = declining); :noDataCount are shown in gray — no data yet (needs at least 2 weeks of tracking).',
    'map_heatmap_legend_growth' => 'Growing',
    'map_heatmap_legend_decline' => 'Declining',
    'map_tab_region_heatmap' => 'Growth by Region',
    'map_summary_region_heatmap' => 'Average weekly growth per Southeast Asian province/state — :count region(s) have data (experimental, for comparison against Growth by Location).',
    'map_tab_church' => 'Church Spread',
