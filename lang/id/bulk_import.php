...
return [
    ...
    'how_step_6' => 'Koordinat lokasinya dicari otomatis di background setelah upload — tidak perlu langkah tambahan. Prosesnya bertahap (sekitar 1 lokasi per detik), jadi untuk data yang banyak bisa makan waktu beberapa menit sampai semua marker muncul di peta.',
    'result' => 'Import selesai — Data: :created dibuat, :updated diperbarui, :skippedInvalid dilewati (Nama kosong), :skippedDaerahNotFound dilewati (Daerah tidak ditemukan), :skippedNotFound dilewati (ID tidak ditemukan), :queued sedang dicari koordinatnya di background. Media Sosial: :socialCreated dibuat, :socialUpdated diperbarui, :socialSkipped dilewati.',
];
